...
public class Scanner {
    ...
    private void addToken(TokenTypes tipo, Object literal) {
        ...
        // System.out.println("Token Adicionado:" + tipo + " " + linha + " " + coluna +
        // " " + literal); // só pra teste
    }
        ...
        switch (c) {
            ...
            case '!':
                if (match('=')) {
                    ...
                    System.out.println(
                            "ERRO: Exclamação (‘!’) não seguida de ‘=’ na linha: " + linha + " e coluna: " + coluna);
                    System.exit(0);
                }
                break;
            case '/':
                if (match('/')) {
                    ...
                    if (noFinal()) {
                        System.out.println("ERRO: Arquivo acabou com um comentário aberto na linha: " + start
                                + " e coluna: " + colunaErro);
                        System.exit(0);
                    }
